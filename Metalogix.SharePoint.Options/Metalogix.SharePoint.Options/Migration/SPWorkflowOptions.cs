...
{
	public class SPWorkflowOptions : OptionsBase
	{
		private bool m_bCopyListOOBWorkflowAssociations;
		...
		private bool _copyPreviousVersionWorkflowInstances;
