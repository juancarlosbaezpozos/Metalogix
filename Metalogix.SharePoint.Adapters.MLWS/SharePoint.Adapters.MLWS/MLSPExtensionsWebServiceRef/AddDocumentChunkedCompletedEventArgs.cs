...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddDocumentChunkedCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddDocumentChunkedCompletedEventArgs(object[] results, Exception exception, bool cancelled,
