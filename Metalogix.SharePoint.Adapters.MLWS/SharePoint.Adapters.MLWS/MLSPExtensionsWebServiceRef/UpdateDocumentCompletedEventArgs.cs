...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class UpdateDocumentCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal UpdateDocumentCompletedEventArgs(object[] results, Exception exception, bool cancelled,
