...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetDocumentIdCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetDocumentIdCompletedEventArgs(object[] results, Exception exception, bool cancelled,
