...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetCustomProfilePropertyMappingCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetCustomProfilePropertyMappingCompletedEventArgs(object[] results, Exception exception,
