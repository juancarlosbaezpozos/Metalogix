...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetBcsApplicationsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetBcsApplicationsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
