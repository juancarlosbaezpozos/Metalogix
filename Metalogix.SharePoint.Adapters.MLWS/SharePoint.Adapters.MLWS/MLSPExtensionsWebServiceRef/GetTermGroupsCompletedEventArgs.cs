...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetTermGroupsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetTermGroupsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
