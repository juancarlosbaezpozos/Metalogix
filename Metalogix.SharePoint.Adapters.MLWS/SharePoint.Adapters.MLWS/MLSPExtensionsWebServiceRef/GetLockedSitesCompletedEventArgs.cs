...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetLockedSitesCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetLockedSitesCompletedEventArgs(object[] results, Exception exception, bool cancelled,
