...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class UpdateListItemStatusCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal UpdateListItemStatusCompletedEventArgs(object[] results, Exception exception, bool cancelled,
