...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteAudienceCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteAudienceCompletedEventArgs(object[] results, Exception exception, bool cancelled,
