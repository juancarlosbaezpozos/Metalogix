...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class ReorderContentTypesCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal ReorderContentTypesCompletedEventArgs(object[] results, Exception exception, bool cancelled,
