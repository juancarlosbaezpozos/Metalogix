...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddOrUpdateRoleCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddOrUpdateRoleCompletedEventArgs(object[] results, Exception exception, bool cancelled,
