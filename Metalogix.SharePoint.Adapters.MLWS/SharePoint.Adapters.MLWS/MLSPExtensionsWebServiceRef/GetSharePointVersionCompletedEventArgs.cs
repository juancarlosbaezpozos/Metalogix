...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetSharePointVersionCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetSharePointVersionCompletedEventArgs(object[] results, Exception exception, bool cancelled,
