...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class Apply2013ThemeCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal Apply2013ThemeCompletedEventArgs(object[] results, Exception exception, bool cancelled,
