...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetDocumentChunkedCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetDocumentChunkedCompletedEventArgs(object[] results, Exception exception, bool cancelled,
