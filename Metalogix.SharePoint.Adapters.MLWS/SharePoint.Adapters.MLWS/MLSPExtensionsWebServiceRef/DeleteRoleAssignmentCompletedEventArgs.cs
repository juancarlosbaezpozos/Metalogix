...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteRoleAssignmentCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteRoleAssignmentCompletedEventArgs(object[] results, Exception exception, bool cancelled,
