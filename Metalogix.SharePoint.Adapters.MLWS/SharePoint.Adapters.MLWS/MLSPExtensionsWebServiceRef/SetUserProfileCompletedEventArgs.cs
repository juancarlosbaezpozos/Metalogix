...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class SetUserProfileCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal SetUserProfileCompletedEventArgs(object[] results, Exception exception, bool cancelled,
