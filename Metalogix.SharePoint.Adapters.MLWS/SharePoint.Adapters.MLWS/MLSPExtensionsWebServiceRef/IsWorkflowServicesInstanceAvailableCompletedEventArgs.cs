...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class IsWorkflowServicesInstanceAvailableCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal IsWorkflowServicesInstanceAvailableCompletedEventArgs(object[] results, Exception exception,
