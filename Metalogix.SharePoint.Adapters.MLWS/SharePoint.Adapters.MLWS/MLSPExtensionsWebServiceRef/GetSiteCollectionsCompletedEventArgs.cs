...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetSiteCollectionsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetSiteCollectionsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
