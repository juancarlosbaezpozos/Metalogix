...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class SetDocumentParsingCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal SetDocumentParsingCompletedEventArgs(object[] results, Exception exception, bool cancelled,
