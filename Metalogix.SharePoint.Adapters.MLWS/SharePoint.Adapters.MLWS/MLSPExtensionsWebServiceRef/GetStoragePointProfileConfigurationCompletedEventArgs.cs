...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetStoragePointProfileConfigurationCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetStoragePointProfileConfigurationCompletedEventArgs(object[] results, Exception exception,
