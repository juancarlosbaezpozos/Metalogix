...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetFarmServerDetailsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetFarmServerDetailsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
