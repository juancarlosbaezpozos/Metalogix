...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteWebPartsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteWebPartsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
