...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class SetMasterPageCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal SetMasterPageCompletedEventArgs(object[] results, Exception exception, bool cancelled,
