...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetListItemsByQueryCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetListItemsByQueryCompletedEventArgs(object[] results, Exception exception, bool cancelled,
