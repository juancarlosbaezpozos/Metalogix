...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetFarmSolutionsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetFarmSolutionsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
