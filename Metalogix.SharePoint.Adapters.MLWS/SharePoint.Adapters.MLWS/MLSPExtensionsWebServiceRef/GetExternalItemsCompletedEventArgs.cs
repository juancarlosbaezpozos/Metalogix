...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetExternalItemsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetExternalItemsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
