...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetDocumentVersionCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetDocumentVersionCompletedEventArgs(object[] results, Exception exception, bool cancelled,
