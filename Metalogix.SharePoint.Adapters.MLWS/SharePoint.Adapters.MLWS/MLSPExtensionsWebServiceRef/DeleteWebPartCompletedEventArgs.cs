...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteWebPartCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteWebPartCompletedEventArgs(object[] results, Exception exception, bool cancelled,
