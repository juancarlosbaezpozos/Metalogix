...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class HasUniquePermissionsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal HasUniquePermissionsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
