...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class ExecuteCommandCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal ExecuteCommandCompletedEventArgs(object[] results, Exception exception, bool cancelled,
