...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetWebApplicationsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetWebApplicationsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
