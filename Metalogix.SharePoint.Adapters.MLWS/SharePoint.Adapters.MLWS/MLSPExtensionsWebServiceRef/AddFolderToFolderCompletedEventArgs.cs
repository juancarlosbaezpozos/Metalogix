...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddFolderToFolderCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddFolderToFolderCompletedEventArgs(object[] results, Exception exception, bool cancelled,
