...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetWebPartPageCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetWebPartPageCompletedEventArgs(object[] results, Exception exception, bool cancelled,
