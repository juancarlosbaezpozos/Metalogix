...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class IsListContainsInfoPathOrAspxItemCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal IsListContainsInfoPathOrAspxItemCompletedEventArgs(object[] results, Exception exception,
