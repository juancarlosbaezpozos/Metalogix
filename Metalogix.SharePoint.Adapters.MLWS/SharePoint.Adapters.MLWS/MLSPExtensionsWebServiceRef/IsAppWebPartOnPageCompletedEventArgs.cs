...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class IsAppWebPartOnPageCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal IsAppWebPartOnPageCompletedEventArgs(object[] results, Exception exception, bool cancelled,
