...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetWebPartsOnPageCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetWebPartsOnPageCompletedEventArgs(object[] results, Exception exception, bool cancelled,
