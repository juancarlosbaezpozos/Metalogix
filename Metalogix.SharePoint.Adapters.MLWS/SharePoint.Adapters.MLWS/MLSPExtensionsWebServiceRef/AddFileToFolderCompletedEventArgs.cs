...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddFileToFolderCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddFileToFolderCompletedEventArgs(object[] results, Exception exception, bool cancelled,
