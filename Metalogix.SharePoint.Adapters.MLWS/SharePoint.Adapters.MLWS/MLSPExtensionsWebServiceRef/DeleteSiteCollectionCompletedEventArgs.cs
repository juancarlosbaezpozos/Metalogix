...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteSiteCollectionCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteSiteCollectionCompletedEventArgs(object[] results, Exception exception, bool cancelled,
