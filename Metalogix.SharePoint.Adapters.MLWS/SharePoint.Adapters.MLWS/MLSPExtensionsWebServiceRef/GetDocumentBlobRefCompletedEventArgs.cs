...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetDocumentBlobRefCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetDocumentBlobRefCompletedEventArgs(object[] results, Exception exception, bool cancelled,
