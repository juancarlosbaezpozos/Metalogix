...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class DeleteContentTypesCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DeleteContentTypesCompletedEventArgs(object[] results, Exception exception, bool cancelled,
