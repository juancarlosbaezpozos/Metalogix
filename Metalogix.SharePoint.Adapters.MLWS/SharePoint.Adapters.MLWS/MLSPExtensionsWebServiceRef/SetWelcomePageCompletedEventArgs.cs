...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class SetWelcomePageCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal SetWelcomePageCompletedEventArgs(object[] results, Exception exception, bool cancelled,
