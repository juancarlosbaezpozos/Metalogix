...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetUserProfilesCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetUserProfilesCompletedEventArgs(object[] results, Exception exception, bool cancelled,
