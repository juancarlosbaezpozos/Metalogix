...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetExternalContentTypeOperationsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetExternalContentTypeOperationsCompletedEventArgs(object[] results, Exception exception,
