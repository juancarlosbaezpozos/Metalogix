...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetMySiteDataCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetMySiteDataCompletedEventArgs(object[] results, Exception exception, bool cancelled,
