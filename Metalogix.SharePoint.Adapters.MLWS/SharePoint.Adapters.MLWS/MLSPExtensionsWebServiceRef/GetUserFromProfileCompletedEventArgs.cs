...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetUserFromProfileCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetUserFromProfileCompletedEventArgs(object[] results, Exception exception, bool cancelled,
