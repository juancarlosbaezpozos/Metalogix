...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class SearchForDocumentCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal SearchForDocumentCompletedEventArgs(object[] results, Exception exception, bool cancelled,
