...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class CloseWebPartsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal CloseWebPartsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
