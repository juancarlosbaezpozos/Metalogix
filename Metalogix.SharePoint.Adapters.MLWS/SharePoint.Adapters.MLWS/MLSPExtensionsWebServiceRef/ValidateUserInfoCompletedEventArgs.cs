...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class ValidateUserInfoCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal ValidateUserInfoCompletedEventArgs(object[] results, Exception exception, bool cancelled,
