...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class ActivateReusableWorkflowTemplatesCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal ActivateReusableWorkflowTemplatesCompletedEventArgs(object[] results, Exception exception,
