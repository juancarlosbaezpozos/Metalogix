...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddOrUpdateAudienceCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddOrUpdateAudienceCompletedEventArgs(object[] results, Exception exception, bool cancelled,
