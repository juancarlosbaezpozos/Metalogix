...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddRoleAssignmentCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddRoleAssignmentCompletedEventArgs(object[] results, Exception exception, bool cancelled,
