...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddListItemChunkedCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddListItemChunkedCompletedEventArgs(object[] results, Exception exception, bool cancelled,
