...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetPortalListingIDsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetPortalListingIDsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
