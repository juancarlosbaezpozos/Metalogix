...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddFolderOptimisticallyCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddFolderOptimisticallyCompletedEventArgs(object[] results, Exception exception, bool cancelled,
