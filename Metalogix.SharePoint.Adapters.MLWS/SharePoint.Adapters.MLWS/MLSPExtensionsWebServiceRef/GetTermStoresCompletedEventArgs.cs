...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class GetTermStoresCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetTermStoresCompletedEventArgs(object[] results, Exception exception, bool cancelled,
