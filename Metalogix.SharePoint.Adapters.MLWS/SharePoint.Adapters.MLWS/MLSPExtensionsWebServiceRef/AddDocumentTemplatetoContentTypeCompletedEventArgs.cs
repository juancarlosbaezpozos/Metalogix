...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddDocumentTemplatetoContentTypeCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddDocumentTemplatetoContentTypeCompletedEventArgs(object[] results, Exception exception,
