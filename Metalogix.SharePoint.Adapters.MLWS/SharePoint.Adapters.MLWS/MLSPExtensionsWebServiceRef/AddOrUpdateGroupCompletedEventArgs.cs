...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class AddOrUpdateGroupCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddOrUpdateGroupCompletedEventArgs(object[] results, Exception exception, bool cancelled,
