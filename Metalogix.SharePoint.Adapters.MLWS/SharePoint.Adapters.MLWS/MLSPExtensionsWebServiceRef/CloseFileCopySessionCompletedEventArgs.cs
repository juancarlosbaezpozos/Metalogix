...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class CloseFileCopySessionCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal CloseFileCopySessionCompletedEventArgs(object[] results, Exception exception, bool cancelled,
