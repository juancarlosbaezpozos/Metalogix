...
namespace Metalogix.SharePoint.Adapters.MLWS.MLSPExtensionsWebServiceRef
{
    ...
    public class UpdateListItemCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal UpdateListItemCompletedEventArgs(object[] results, Exception exception, bool cancelled,
