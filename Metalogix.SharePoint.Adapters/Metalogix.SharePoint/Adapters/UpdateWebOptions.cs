...
{
    [DataContract]
    public class UpdateWebOptions : AdapterOptions, IUpdateWebOptions
    {
        private bool m_bCopyCore;
        ...
        {
            get { return this.m_bCopyCore; }
            set { this.m_bCopyCore = value; }
        }
