<%@ Page language="C#" MasterPageFile="~masterurl/default.master" Inherits="Microsoft.SharePoint.Portal.WebControls.DashboardPage,Microsoft.SharePoint.Portal,Version=14.0.0.0,Culture=neutral,PublicKeyToken=71e9bce111e9429c" %>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" ID="BottomZoneTable" width="100%">
        <tr ID="MiddleRow" class="ms-tzbottom">
            ...
            <td valign="top" ID="MiddleMiddleCell">
                <WebPartPages:WebPartZone runat="server" AllowPersonalization="false" ID="MiddleMiddleZone" Title="<%$Resources:sps,DashboardTemplate_MiddleZone%>" Orientation="Vertical" QuickAdd-GroupNames="Dashboard" BorderWidth="3"/>
            </td>
        ...
        <tr ID="BottomRow" class="ms-tzbottom">
            ...
            <td valign="top" ID="BottomMiddleCell">
                <WebPartPages:WebPartZone runat="server" AllowPersonalization="false" ID="BottomMiddleZone" Title="<%$Resources:sps,DashboardTemplate_BottomMiddleZone%>" Orientation="Vertical" QuickAdd-GroupNames="Dashboard" BorderWidth="3"/>
            </td>
