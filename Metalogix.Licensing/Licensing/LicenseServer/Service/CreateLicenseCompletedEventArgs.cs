...
namespace Metalogix.Licensing.LicenseServer.Service
{
    ...
    public class CreateLicenseCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal CreateLicenseCompletedEventArgs(object[] results, Exception exception, bool cancelled,
