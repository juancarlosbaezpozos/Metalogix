...
namespace Metalogix.Licensing.LicenseServer.Service
{
    ...
    public class CreateTrialLicenseCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal CreateTrialLicenseCompletedEventArgs(object[] results, Exception exception, bool cancelled,
