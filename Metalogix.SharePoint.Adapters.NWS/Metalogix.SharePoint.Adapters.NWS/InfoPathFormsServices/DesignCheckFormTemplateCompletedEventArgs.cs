...
namespace Metalogix.SharePoint.Adapters.NWS.InfoPathFormsServices
{
    ...
    public class DesignCheckFormTemplateCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal DesignCheckFormTemplateCompletedEventArgs(object[] results, Exception exception, bool cancelled,
