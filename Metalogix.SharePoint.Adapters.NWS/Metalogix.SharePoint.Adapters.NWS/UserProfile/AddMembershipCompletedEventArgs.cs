...
namespace Metalogix.SharePoint.Adapters.NWS.UserProfile
{
    ...
    public class AddMembershipCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddMembershipCompletedEventArgs(object[] results, Exception exception, bool cancelled,
