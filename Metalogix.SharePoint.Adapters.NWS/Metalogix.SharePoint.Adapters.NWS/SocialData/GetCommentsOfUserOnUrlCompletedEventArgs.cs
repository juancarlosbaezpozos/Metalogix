...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetCommentsOfUserOnUrlCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetCommentsOfUserOnUrlCompletedEventArgs(object[] results, Exception exception, bool cancelled,
