...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetRatingOnUrlCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetRatingOnUrlCompletedEventArgs(object[] results, Exception exception, bool cancelled,
