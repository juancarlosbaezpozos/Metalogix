...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetAllTagUrlsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetAllTagUrlsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
