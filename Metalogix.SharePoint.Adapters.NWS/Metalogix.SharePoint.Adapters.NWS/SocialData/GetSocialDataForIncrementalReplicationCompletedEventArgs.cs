...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetSocialDataForIncrementalReplicationCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetSocialDataForIncrementalReplicationCompletedEventArgs(object[] results, Exception exception,
