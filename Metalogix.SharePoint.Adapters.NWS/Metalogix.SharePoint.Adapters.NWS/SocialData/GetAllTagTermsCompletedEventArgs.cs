...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetAllTagTermsCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetAllTagTermsCompletedEventArgs(object[] results, Exception exception, bool cancelled,
