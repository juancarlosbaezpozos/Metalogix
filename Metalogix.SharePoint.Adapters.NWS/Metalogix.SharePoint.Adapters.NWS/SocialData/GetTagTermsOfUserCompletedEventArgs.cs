...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetTagTermsOfUserCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetTagTermsOfUserCompletedEventArgs(object[] results, Exception exception, bool cancelled,
