...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetTagsOfUserCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetTagsOfUserCompletedEventArgs(object[] results, Exception exception, bool cancelled,
