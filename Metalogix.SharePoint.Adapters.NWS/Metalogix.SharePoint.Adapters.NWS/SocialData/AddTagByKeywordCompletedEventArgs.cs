...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class AddTagByKeywordCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal AddTagByKeywordCompletedEventArgs(object[] results, Exception exception, bool cancelled,
