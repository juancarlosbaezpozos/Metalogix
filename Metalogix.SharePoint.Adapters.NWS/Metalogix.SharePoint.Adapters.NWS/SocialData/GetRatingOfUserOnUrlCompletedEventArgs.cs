...
namespace Metalogix.SharePoint.Adapters.NWS.SocialData
{
    ...
    public class GetRatingOfUserOnUrlCompletedEventArgs : AsyncCompletedEventArgs
    {
        ...
        internal GetRatingOfUserOnUrlCompletedEventArgs(object[] results, Exception exception, bool cancelled,
