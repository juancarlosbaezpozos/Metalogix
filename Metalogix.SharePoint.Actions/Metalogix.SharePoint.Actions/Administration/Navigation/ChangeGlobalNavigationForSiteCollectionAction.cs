...
{
	[MenuText("Change Site Collection Settings {3-Update} > 2:Global Navigation Settings... ")]
	[ShowInMenus(true)]
	public class ChangeGlobalNavigationForSiteCollectionAction : ChangeGlobalNavigationAction
	{
		public ChangeGlobalNavigationForSiteCollectionAction()
		{
		}
