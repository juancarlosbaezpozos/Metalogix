...
{
	public class SPFieldComparer : IListPickerComparer, IComparer<ListPickerItem>
	{
		public SPFieldComparer()
		{
		}

		public bool AppliesTo(ListPickerItem source, ListPickerItem target)
		{
			if (source == null || source.Tag != null || target == null || target.Tag == null)
			{
				return false;
			}
