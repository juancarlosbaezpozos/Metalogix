...
{
	[ActionConfig(new Type[] { typeof(CopyListAlertsAction) })]
	public class CopyListAlertsConfig : IActionConfig
	{
		public CopyListAlertsConfig()
		{
		}
		...
		public ConfigurationResult Configure(ActionConfigContext context)
		{
			...
			bool isSharePointOnline = (context.ActionContext.Targets[0] as SPList).Adapter.SharePointVersion.IsSharePointOnline;
			CopyAlertsDialog copyAlertsDialog = new CopyAlertsDialog(true, isSharePointOnline)
			{
