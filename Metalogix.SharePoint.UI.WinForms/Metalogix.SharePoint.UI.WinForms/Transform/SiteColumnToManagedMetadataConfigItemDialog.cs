...
{
    public class SiteColumnToManagedMetadataConfigItemDialog : XtraForm
    {
        ...
        private TextEdit _txtSite;

        private TextEdit _txtSiteColumn;

        private LabelControl _lblTermStore;

        private LabelControl _lblSiteColumn;

        private LabelControl _lblSite;
        ...
        private SimpleButton _btnEditSiteFilter;

        private SimpleButton _btnEditSiteColumnFilter;
        ...
        public SiteColumnToManagedMetadataOption Option { get; set; }
        ...
        private SPTermStoreCollection TermStoreCollection
        {
            get
            {
                if (_tsCollection == null)
                {
                    ...
                    else if (_context.ActionContext.Targets[0] is SPList && (_context.ActionContext.Targets[0] as SPList).ParentWeb != null)
                    {
        ...
        public SiteColumnToManagedMetadataConfigItemDialog(bool isNewItem, TransformerConfigContext context, SiteColumnToManagedMetadataOption option)
        {
            _isNew = isNewItem;
            Option = option;
            _context = context;
        ...
        private void btnEditSiteColumnFilter_OnClick(object sender, EventArgs e)
        {
            using (FilterExpressionEditorDialog filterExpressionEditorDialog = new FilterExpressionEditorDialog())
            {
                filterExpressionEditorDialog.Title = Resources.SCMMDSiteColumnFilterTitle;
                Type[] collection = new Type[1] { typeof(SPField) };
                filterExpressionEditorDialog.FilterableTypes = new FilterBuilderType(new List<Type>(collection), bAllowFreeFormEntry: true);
                filterExpressionEditorDialog.LabelText = Resources.SCMMDSiteColumnFilterLabel;
                if (Option == null || Option.SiteColumnFilterExpression == null)
                {
                ...
                {
                    filterExpressionEditorDialog.FilterExpression = Option.SiteColumnFilterExpression;
                }
                filterExpressionEditorDialog.ShowDialog();
                if (filterExpressionEditorDialog.DialogResult == DialogResult.OK)
                {
                    Option.SiteColumnFilterExpression = filterExpressionEditorDialog.FilterExpression;
                    _txtSiteColumn.Text = Option.FieldFilter;
                    _txtSiteColumn.IsModified = true;
                    _txtSiteColumn.DoValidate();
                    _modified = true;
                }
            }
        }

        private void btnEditSiteFilter_OnClick(object sender, EventArgs e)
        {
            using (FilterExpressionEditorDialog filterExpressionEditorDialog = new FilterExpressionEditorDialog())
            {
                filterExpressionEditorDialog.Title = Resources.SCMMDCSiteFilterTitle;
                Type[] collection = new Type[1] { typeof(SPWeb) };
                filterExpressionEditorDialog.FilterableTypes = new FilterBuilderType(new List<Type>(collection), bAllowFreeFormEntry: true);
                filterExpressionEditorDialog.LabelText = Resources.SCMMDCSiteFilterLabel;
                if (Option != null)
                {
                    filterExpressionEditorDialog.FilterExpression = Option.SiteFilterExpression;
                }
                filterExpressionEditorDialog.ShowDialog();
                if (filterExpressionEditorDialog.DialogResult == DialogResult.OK)
                {
                    Option.SiteFilterExpression = filterExpressionEditorDialog.FilterExpression;
                    _txtSite.Text = Option.SiteFilter;
                    _txtSite.IsModified = true;
                    _txtSite.DoValidate();
                    _modified = true;
                }
            }
        ...
        {
            _txtNewFieldName.Enabled = _cbCreateNewField.Checked;
            _txtNewDisplayName.Enabled = _cbCreateNewField.Checked;
        ...
        private void ConfigureGroupChange(bool clearSelection)
        {
            ...
            _cbTermSet.Properties.ReadOnly = true;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Metalogix.SharePoint.UI.WinForms.Transform.SiteColumnToManagedMetadataConfigItemDialog));
            ...
            this._lblSiteColumn = new DevExpress.XtraEditors.LabelControl();
            this._lblSite = new DevExpress.XtraEditors.LabelControl();
            this._txtSiteColumn = new DevExpress.XtraEditors.TextEdit();
            this._txtSite = new DevExpress.XtraEditors.TextEdit();
            ...
            this._btnEditSiteFilter = new DevExpress.XtraEditors.SimpleButton();
            this._btnEditSiteColumnFilter = new DevExpress.XtraEditors.SimpleButton();
            ...
            this._pnlWait = new System.Windows.Forms.Panel();
            ...
            ((System.ComponentModel.ISupportInitialize)this._txtSiteColumn.Properties).BeginInit();
            ((System.ComponentModel.ISupportInitialize)this._txtSite.Properties).BeginInit();
            ...
            this._cbCreateNewField.Properties.Caption = "Transform to new column";
            this._cbCreateNewField.Size = new System.Drawing.Size(144, 19);
            ...
            this._lblSiteColumn.Location = new System.Drawing.Point(8, 59);
            this._lblSiteColumn.Name = "_lblSiteColumn";
            this._lblSiteColumn.Size = new System.Drawing.Size(56, 13);
            this._lblSiteColumn.TabIndex = 3;
            this._lblSiteColumn.Text = "Site Column";
            this._lblSite.Location = new System.Drawing.Point(8, 32);
            this._lblSite.Name = "_lblSite";
            this._lblSite.Size = new System.Drawing.Size(18, 13);
            this._lblSite.TabIndex = 0;
            this._lblSite.Text = "Site";
            this._txtSiteColumn.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
            this._txtSiteColumn.Location = new System.Drawing.Point(82, 56);
            this._txtSiteColumn.Name = "_txtSiteColumn";
            this._txtSiteColumn.Properties.ReadOnly = true;
            this._txtSiteColumn.Size = new System.Drawing.Size(256, 20);
            this._txtSiteColumn.TabIndex = 4;
            this._txtSiteColumn.TabStop = false;
            this._txtSite.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
            this._txtSite.Location = new System.Drawing.Point(82, 29);
            this._txtSite.Name = "_txtSite";
            this._txtSite.Properties.ReadOnly = true;
            this._txtSite.Size = new System.Drawing.Size(256, 20);
            this._txtSite.TabIndex = 1;
            this._txtSite.TabStop = false;
            ...
            this._btnEditSiteFilter.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
            this._btnEditSiteFilter.ImageLocation = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
            this._btnEditSiteFilter.Location = new System.Drawing.Point(344, 29);
            this._btnEditSiteFilter.Name = "_btnEditSiteFilter";
            this._btnEditSiteFilter.Size = new System.Drawing.Size(27, 20);
            toolTipTitleItem.Text = "Source Site Filter Condition";
            toolTipItem.LeftIndent = 6;
            toolTipItem.Text = "Define the filter condition to use to find the source site.";
            superToolTip.Items.Add(toolTipTitleItem);
            superToolTip.Items.Add(toolTipItem);
            this._btnEditSiteFilter.SuperTip = superToolTip;
            this._btnEditSiteFilter.TabIndex = 2;
            this._btnEditSiteFilter.Text = "...";
            this._btnEditSiteFilter.Click += new System.EventHandler(btnEditSiteFilter_OnClick);
            this._btnEditSiteColumnFilter.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
            this._btnEditSiteColumnFilter.ImageLocation = DevExpress.XtraEditors.ImageLocation.MiddleCenter;
            this._btnEditSiteColumnFilter.Location = new System.Drawing.Point(344, 56);
            this._btnEditSiteColumnFilter.Name = "_btnEditSiteColumnFilter";
            this._btnEditSiteColumnFilter.Size = new System.Drawing.Size(27, 20);
            toolTipTitleItem2.Text = "Source Site Column Filter Condition";
            toolTipItem2.LeftIndent = 6;
            toolTipItem2.Text = "Define the filter condition to use to find the source site column.";
            superToolTip2.Items.Add(toolTipTitleItem2);
            superToolTip2.Items.Add(toolTipItem2);
            this._btnEditSiteColumnFilter.SuperTip = superToolTip2;
            this._btnEditSiteColumnFilter.TabIndex = 5;
            this._btnEditSiteColumnFilter.Text = "...";
            this._btnEditSiteColumnFilter.Click += new System.EventHandler(btnEditSiteColumnFilter_OnClick);
            ...
            this._lblLoading.Location = new System.Drawing.Point(0, 0);
            this._lblLoading.Name = "_lblLoading";
            this._lblLoading.Size = new System.Drawing.Size(400, 388);
            ...
            this._txtAnchor.Size = new System.Drawing.Size(257, 20);
            ...
            this._groupSource.Controls.Add(this._txtSite);
            this._groupSource.Controls.Add(this._btnEditSiteColumnFilter);
            this._groupSource.Controls.Add(this._txtSiteColumn);
            this._groupSource.Controls.Add(this._btnEditSiteFilter);
            this._groupSource.Controls.Add(this._lblSite);
            this._groupSource.Controls.Add(this._lblSiteColumn);
            ...
            this._groupTarget.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
            ...
            this._helpCreateNewField.Location = new System.Drawing.Point(230, 142);
            ...
            this._lblFieldName.TabIndex = 8;
            this._lblFieldName.Text = "Column";
            ...
            this._gridSubstitute.TabIndex = 44;
            ...
            this._lblTransform.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
            this._lblTransform.Location = new System.Drawing.Point(11, 5);
            this._lblTransform.Name = "_lblTransform";
            this._lblTransform.Size = new System.Drawing.Size(309, 13);
            this._lblTransform.TabIndex = 0;
            this._lblTransform.Text = "Transform Source Site Columns into Managed Metadata Columns";
            ...
            base.Name = "SiteColumnToManagedMetadataConfigItemDialog";
            base.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Show;
            base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Configure Transformation for a Site Column";
            ...
            ((System.ComponentModel.ISupportInitialize)this._txtSiteColumn.Properties).EndInit();
            ((System.ComponentModel.ISupportInitialize)this._txtSite.Properties).EndInit();
        ...
        {
            BaseEdit baseEdit = (BaseEdit)sender;
            if (Regex.IsMatch(baseEdit.Text.Trim(), "^[A-Za-z\\x5F][0-9A-Za-z\\x5F]+$"))
            {
                baseEdit.ErrorText = string.Empty;
            }
            else
        ...
        {
            BaseEdit baseEdit = (BaseEdit)sender;
            if (!Regex.IsMatch(baseEdit.Text.Trim(), "[\\x22\\x3B\\x3C\\x3E\\x7C\\x09]"))
            {
                baseEdit.ErrorText = string.Empty;
            }
            else
        ...
        private bool ValidateInput()
        {
            ...
            BaseEdit[] collection = new BaseEdit[5] { _txtSite, _txtSiteColumn, _cbTermStore, _cbGroup, _cbTermSet };
